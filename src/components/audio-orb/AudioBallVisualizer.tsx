...
const PALETTES: Record<AudioState, StatePalette> = {
  idle: {
    ...
    glowAlpha: 'rgba(148, 163, 184, 0)',
    orb1: 'rgba(203, 213, 225, 0.95)',
    orb2: 'rgba(71, 85, 105, 0.85)',
    ring: 'rgba(148, 163, 184, 0.35)',
    bars: 'rgba(148, 163, 184, 0.6)',
  },
  listening: {
    glow: 'rgba(16, 185, 129, 0.7)',
    glowAlpha: 'rgba(16, 185, 129, 0)',
    orb1: 'rgba(110, 231, 183, 0.95)',
    orb2: 'rgba(6, 95, 70, 0.85)',
    ring: 'rgba(45, 212, 191, 0.55)',
    bars: 'rgba(34, 211, 238, 0.85)',
  },
  thinking: {
    glow: 'rgba(245, 158, 11, 0.65)',
    glowAlpha: 'rgba(245, 158, 11, 0)',
    orb1: 'rgba(252, 211, 77, 0.95)',
    orb2: 'rgba(146, 64, 14, 0.85)',
    ring: 'rgba(168, 85, 247, 0.55)',
    bars: 'rgba(168, 85, 247, 0.85)',
  },
  speaking: {
    glow: 'rgba(168, 85, 247, 0.85)',
    glowAlpha: 'rgba(168, 85, 247, 0)',
    orb1: 'rgba(216, 180, 254, 0.95)',
    orb2: 'rgba(76, 29, 149, 0.9)',

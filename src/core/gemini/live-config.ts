...
export function buildSystemInstruction(
  ...
  return [
    ...
    `1. INITIATE AND LEAD THE INTERVIEW IMMEDIATELY (YOU SPEAK FIRST):`,
    `   - As the Board Chairman / Interviewing Officer, YOU MUST SPEAK FIRST as soon as the session starts. Do not wait for the candidate to speak or greet you.`,
    `   - Formally welcome ${candidateName} to the ${examCategory} interview board, introduce yourself (${officer.name}, ${officer.designation}), and immediately ask your opening question to set the tone.`,
